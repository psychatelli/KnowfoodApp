...
export  const setToken = async (token) => {
    ...
    if(token){
      ...
      console.log(`this is header: ${JSON.stringify(HEADER)}`) 
  ...
  //       // loadUser(value);
  //       console.log(`GETTOKEN FIRED - Whats wrong here ${value}`);
  //       if(value){
          
  //         axios.defaults.headers.common['x-auth-token'] = value;
  //          console.log(`got to se headers`)
  ...
  export  const getAsyncStorage = async () => {
    ...
    try { 
      ...
      //  console.log(`THIS IS REAL TOKEN IN HEADER ${Value}`)
       ...
       console.log(`what is vaue of header stripped down: ${TheToken}`)
